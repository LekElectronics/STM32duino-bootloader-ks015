...
generic-pa3: begin clean gccversion build_generic-pa3 sizeafter finished  copy_generic-pa3 end
...
build_generic-pa3: TARGETFLAGS= -DTARGET_GENERIC_F103_PA3 $(DEFINES)
# Set the linker script
build_generic-pa3: LDFLAGS +=-T$(ST_LIB)/c_only_md_high_density.ld
build_generic-pa3: elf bin lss sym
copy_generic-pa3:
	@echo
	@echo "Copying to binaries folder"
	@echo
	cp $(TARGET).bin bootloader_only_binaries/generic_boot20_pa3.bin
	@echo
